...
const bookingData = computed(() => {
    ...
    return {
        ...
        total_amount: normalizeTotalValue(props.totals?.grandTotal),
        currency: totalsSourceCurrency.value,
        display_currency: checkoutCurrency.value,
        quoteid: props.vehicle.quoteid || null,
        rentalCode: props.vehicle.rentalCode || null,
        vehicle_total: normalizeTotalValue(props.vehicleTotal || 0),
