    ...
    <div>
      ...
      <div v-if="isOpen" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90"
        ...
        <div class="relative w-full h-full flex flex-col">
          ...
          <!-- Navigation arrows -->
          <button @click="prevImage" class="absolute left-4 top-1/2 text-white text-4xl z-10 px-5 py-2 bg-[#00000027]">
            &#10094;
          </button>
          <button @click="nextImage" class="absolute right-4 top-1/2 text-white text-4xl z-10 px-5 py-2 bg-[#00000027]">
            &#10095;
          </button>
