          ...
          <div class="relative ml-3">
            <Dropdown align="right" width="48">
              <template #trigger>
                <button 
                  type="button"
                  class="inline-flex items-center gap-2 py-2 border border-transparent text-sm font-medium rounded-full bg-white hover:bg-gray-50 focus:outline-none  transition duration-150 ease-in-out group"
                >
      ...
      <div class="pt-2 pb-4 space-y-1 border-t border-gray-200 bg-gray-50">
        ...
        <div v-if="isAuthenticated" class="px-4 py-3">
          ...
          <div class="mt-4 space-y-2">
            ...
            <!-- Logout Button -->
                <ResponsiveNavLink :href="route('logout')" method="post" as="button" class="flex items-center">
                  <svg class="mr-3 h-5 w-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"></path>
                  </svg>
                  Log Out
        ...
        <div v-else class="px-4 py-3 space-y-3">
          <Link 
            :href="route('login')" 
            class="block w-full py-2 px-4 text-center font-medium text-white bg-customPrimaryColor hover:bg-[#153b4fec] rounded-md transition duration-150 ease-in-out"
          >
            Log in
          </Link>
          ...
          <Link 
            :href="route('register')" 
            class="block w-full py-2 px-4 text-center font-medium text-blue-600 bg-white border border-blue-600 hover:bg-blue-50 rounded-md transition duration-150 ease-in-out"
          >
            Create an Account
          </Link>
