    ...
    <SidebarInset>
      ...
      <div class="flex flex-1 flex-col gap-4 p-4 pt-0">
        <div class="grid auto-rows-min gap-4 md:grid-cols-3">
          <div class="aspect-video rounded-xl bg-muted/50 flex flex-col justify-center items-center">
            <span class="text-[2.5rem] font-medium">Total Users</span>
            <span v-if="loading" class="text-sm text-gray-500">Loading...</span>
            <span v-else class="text-[1.5rem] font-semibold">{{ userCount }}</span>
          </div>
        ...
        <div class="min-h-[100vh] flex-1 rounded-xl bg-muted/50 md:min-h-min">
          ...
          <div>
    <!-- Display user table details -->
    <div v-if="!loading" class="mt-5">
      <h2 class="text-lg font-semibold">User Details</h2>
      <table class="table-auto border-collapse border border-gray-300 mt-3 w-full">
        <thead>
