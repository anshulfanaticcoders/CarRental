...
const syncSeoFallbackFields = () => {
    ...
    form.seo_title = `${fallbackSeo.seo_title || ''}`.trim() || `${fallbackTranslation.title || ''}`.trim();
...
const submitForm = () => {
    ...
    form.post(route('admin.blogs.store'), {
        ...
        onSuccess: () => {
            ...
            form.seo_translations = JSON.parse(JSON.stringify(initialSeoTranslations));
            syncSeoFallbackFields();
            props.available_locales.forEach((locale) => {
                slugAuto.value[locale] = true
            })
        ...
        onError: (formErrors) => {
            for (const key in formErrors) {
                if (key.startsWith('translations.') || key === 'image') {
          ...
          <div class="p-8">
            <div class="flex items-center space-x-4 mb-8">
              ...
              <div>
                ...
                <p class="text-gray-600">Add a new blog post with localized content</p>
              </div>
            </div>
            ...
            <form @submit.prevent="submitForm">
              ...
              <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                ...
                <div v-if="form.processing" class="flex items-center text-blue-600">
                  ...
                  <span class="text-sm font-medium">Creating blog post...</span>
                </div>
              </div>
            </form>
          </div>
