...
const form = useForm({
  ...
  icon_url: props.feature.icon_url || '',
});
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
          <div class="p-8">
            <div class="flex items-center space-x-4 mb-8">
              ...
              <div>
                <h1 class="text-2xl font-bold text-gray-900">Edit Feature: {{ feature.feature_name }}</h1>
                <p class="text-gray-600">Update the feature for category: {{ feature.category.name }}</p>
              </div>
            </div>
            ...
            <form @submit.prevent>
              ...
              <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                  ...
                  <AlertDialog>
                    <AlertDialogTrigger as-child>
                      ...
                      >
                        ...
                        {{ form.processing ? 'Updating...' : 'Update Feature' }}
                      </Button>
                    </AlertDialogTrigger>
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        <AlertDialogTitle>Update Feature?</AlertDialogTitle>
                        <AlertDialogDescription>
                          Are you sure you want to update the feature "{{ feature.feature_name }}"?
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
                ...
                <div v-if="form.processing" class="flex items-center text-customPrimaryColor">
                  ...
                  <span class="text-sm font-medium">Updating feature...</span>
                </div>
              </div>
            </form>
          </div>
