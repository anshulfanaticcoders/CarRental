  ...
  <AdminDashboardLayout>
    <template #header>
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">
        Add Feature to <span class="font-bold">{{ category.name }}</span>
      </h2>
    </template>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6 bg-white border-b border-gray-200">
            ...
            <form @submit.prevent="submit">
              ...
              <div class="mb-4">
                <label for="icon_url" class="block text-sm font-medium text-gray-700">Icon URL</label>
              ...
              <div class="flex items-center justify-end mt-6">
                ...
                <button type="submit"
                        ...
                        class="px-4 py-2 bg-blue-500 text-white rounded-md hover:bg-blue-700 disabled:bg-blue-300">
                  Add Feature
                </button>
              </div>
            </form>
