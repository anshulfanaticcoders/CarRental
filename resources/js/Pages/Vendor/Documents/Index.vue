            ...
            <Dialog v-model:open="isViewDialogOpen">
                <DialogContent class="max-w-[90vw] max-h-[90vh] overflow-auto">
                    ...
                    <div class="flex justify-center items-center p-4">
                        <img :src="selectedDocumentPath" alt="Document Preview"
            ...
            <div class="rounded-md border p-5 mt-[1rem] bg-[#153B4F0D]">
                <div v-if="document">
                    <Table>
                        <TableHeader>
                            <TableRow>
                                <TableHead class="text-nowrap">Driving License Front</TableHead>
                                <TableHead class="text-nowrap">Driving License Back</TableHead>
                        ...
                        <TableBody>
                            <TableRow>
                                <TableCell class="text-nowrap">
                                    <img :src="`${document.driving_license_front}`" alt="Driving License"
                                        class="w-[150px] h-[100px] mb-2 object-cover">
                                    <Button v-if="document.driving_license_front" variant="outline" size="sm"
                                        @click="viewDocument(document.driving_license_front)"
                                ...
                                <TableCell class="text-nowrap">
                                    <img :src="`${document.driving_license_back}`" alt="Driving License"
                                        class="w-[150px] h-[100px] mb-2 object-cover">
                                    <Button v-if="document.driving_license_back" variant="outline" size="sm"
                                        @click="viewDocument(document.driving_license_back)"
                                        class="w-[150px]  max-[768px]:w-full">
                                        View
                                    </Button>
                                    <span v-else>Not uploaded</span>
                                ...
                                <TableCell class="text-nowrap">
                                    <img :src="`${document.passport_front}`" alt="Passport"
                                        class="w-[150px] h-[100px] mb-2 object-cover">
                                ...
                                <TableCell class="text-nowrap">
                                    <img :src="`${document.passport_back}`" alt="Passport"
                                        class="w-[150px] h-[100px] mb-2 object-cover">
