...
<template>
    ...
    <section class="full-w-container">
        <div class="flex justify-center items-center h-[80vh] max-[768px]:h-auto">
            <div class="flex flex-col justify-center items-center w-[650px] max-[768px]:w-full">
                ...
                <template v-if="vendorStatus === 'pending'">
                    ...
                    <h3 class="text-[#333333] text-[1.75rem] text-center max-[768px]:my-4 max-[768px]:text-[1.2rem]">Account Verification Pending</h3>
                ...
                <template v-else-if="vendorStatus === 'rejected'">
                    ...
                    <h3 class="text-[#333333] text-[1.75rem] text-center max-[768px]:my-4 max-[768px]:text-[1.2rem]">Rejected</h3>
                    <p class="text-center max-[768px]:text-[0.875rem]">
         ...
         <h3 class="text-[#333333] text-[1.75rem] text-center max-[768px]:my-4 max-[768px]:text-[1.2rem]">Approved</h3>
         <p class="text-center max-[768px]:text-[0.875rem]">Congratulations! Your account has been successfully verified. You can now start listing your vehicles and managing your fleet effortlessly. Click the button below to add your first vehicle.</p>
                </template>
            </div>
        </div>
    </section>
