  ...
  <MyProfileLayout>
    <div class="container mx-auto px-4 max-[768px]:px-0">
      ...
      <p
        ...
        {{ _t('customerbooking', 'confirmed_bookings_header') }}</p>
        ...
        <div class="flex flex-col justify-center items-center">
          ...
          <p>{{ _t('customerbooking', 'no_confirmed_bookings_found') }}</p>
        </div>
      </div>
          ...
          <div class="w-[67%] flex flex-col gap-5 max-[768px]:w-full">
            <div class="flex justify-between items-center max-[768px]:flex-wrap">
              <div class="flex justify-between items-center gap-10 max-[768px]:gap-5">
                ...
                <span v-if="booking.vehicle?.category"
                  class="bg-customLightPrimaryColor p-3 rounded-[99px] text-[1rem] max-[768px]:text-[0.5rem]">
              ...
              <span class="bg-[#0099001A] text-[#009900] px-[1.5rem] py-[0.75rem] rounded-[99px] max-[768px]:text-[0.75rem]">{{ _t('customerbooking', 'booking_status_confirmed') }}</span>
            </div>

            <!-- Specs (Only show if vehicle relationship exists) -->
