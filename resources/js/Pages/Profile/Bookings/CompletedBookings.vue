          ...
          <div class="w-[67%] flex flex-col gap-5 max-[480px]:w-full">
            <div class="flex justify-between items-center">
              <div class="flex justify-between items-center gap-10 max-[480px]:gap-5">
                <span class="text-[2rem] font-medium text-customPrimaryColor max-[480px]:text-[1.2rem]">{{ booking.vehicle.brand }}</span>
                <span class="bg-customLightPrimaryColor p-3 rounded-[99px] text-[1rem] max-[480px]:text-[0.5rem]">{{ booking.vehicle?.category?.name }}</span>
              </div>
              <span class="bg-[#0099001A] text-[#009900] px-[1.5rem] py-[0.75rem] rounded-[99px] max-[480px]:text-[0.75rem]">Trip Completed</span>
            </div>
