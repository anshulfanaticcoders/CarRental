<template>
      ...
      <form @submit.prevent="submit" enctype="multipart/form-data">
        <div class="grid grid-cols-1 gap-5">
          ...
          <div class="flex flex-col gap-2">
            ...
            />
            <div v-if="filePreviews.driving_license_front" class="relative w-[150px] mt-2">
              <img
                :src="filePreviews.driving_license_front"
                alt="Preview"
          ...
          <div class="flex flex-col gap-2">
            ...
            />
            <div v-if="filePreviews.driving_license_back" class="relative w-[150px] mt-2">
              <img
                :src="filePreviews.driving_license_back"
                alt="Preview"
                class="w-full h-[100px] object-cover rounded-md border shadow-md"
              />
              <button
          ...
          <div class="flex flex-col gap-2">
            ...
            />
            <div v-if="filePreviews.passport_front" class="relative w-[150px] mt-2">
              <img
                :src="filePreviews.passport_front"
                alt="Preview"
                class="w-full h-[100px] object-cover rounded-md border shadow-md"
              />
              <button
          ...
          <div class="flex flex-col gap-2">
            ...
            />
            <div v-if="filePreviews.passport_back" class="relative w-[150px] mt-2">
              <img
                :src="filePreviews.passport_back"
                alt="Preview"
                class="w-full h-[100px] object-cover rounded-md border shadow-md"
              />
              <button
  ...
  const submit = () => {
    ...
    const allFilesSelected = requiredFiles.every((field) => form.value[field] !== null);
    if (!allFilesSelected) {
