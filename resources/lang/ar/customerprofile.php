...
return [
        ...
        'paid' => 'مدفوع',
        'booking_cancelled_title' => 'تم إلغاء هذا الحجز',
        'cancelled_refund_note' => 'تم إجراء دفعة لهذا الحجز. يتولى فريقنا معالجة المبالغ المستردة شخصيًا وسيتواصل معك. استخدم خيارات الدعم أدناه إذا لم تتلقَّ ردًا منا.',
        'payment_held_note' => 'تم الاحتفاظ بالدفعة أثناء معالجة هذا الحجز. راجع الإشعار أعلاه.',
