...
class LegacyProviderSearchService
{
    public function __construct(
        ...
        private readonly RecordGoService $recordGoService,
    ...
    public function buildPageProps(
        ...
        $brands = $pageMeta['brands'] ?? [];
        $colors = $pageMeta['colors'] ?? [];
        $seatingCapacities = $pageMeta['seatingCapacities'] ?? [];
        $transmissions = $pageMeta['transmissions'] ?? [];
        $fuels = $pageMeta['fuels'] ?? [];
        $mileages = $pageMeta['mileages'] ?? [];
        $vehicleListSchema = $pageMeta['schema'] ?? null;
        ...
        $emptyResultsResponse = fn (?string $searchError = null): array => $this->buildEmptyPageProps($request, $validated, $searchError);
        ...
        $categoriesFromOptions = $pageMeta['categories'] ?? [];
    ...
    private function buildEmptyPageProps(Request $request, array $validated, ?string $searchError = null): array
    {
        $emptyVehicles = new LengthAwarePaginator(
            collect(),
            0,
            500,
            1,
