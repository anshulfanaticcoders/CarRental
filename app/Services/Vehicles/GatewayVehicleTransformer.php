...
class GatewayVehicleTransformer
{
    ...
    private function transformCanonicalSearchVehicle(array $gv, int $rentalDays): array
    {
        ...
        return [
            ...
            'pickup_address' => $providerPayload['pickup_address'] ?? null,
            'dropoff_address' => $providerPayload['dropoff_address'] ?? null,
            'fuel_policy' => $policies['fuel_policy'] ?? null,
            ...
            'protections' => [],
            'office_address' => $providerPayload['office_address'] ?? null,
            'office_phone' => $providerPayload['office_phone'] ?? null,
            'office_schedule' => $providerPayload['office_schedule'] ?? null,
            'at_airport' => $providerPayload['at_airport'] ?? false,
