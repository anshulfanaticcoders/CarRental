...
class VehicleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'mileage' => 'required|integer|min:0|max:120',
            ...
            'co2' => 'required|integer|min:0|max:9999',
            'vendor_location_id' => [
                'required',
            ...
            'features' => 'array',
            'featured' => 'boolean',
            'security_deposit' => 'required|decimal:0,2|min:0|max:99999999.99',
            ...
            'price_per_day' => 'required|decimal:0,2|min:0.01|max:99999999.99',
            'price_per_week' => 'nullable|decimal:0,2|min:0|max:99999999.99',
            'weekly_discount' => 'nullable|decimal:0,2|min:0|max:100000',
            'price_per_month' => 'nullable|decimal:0,2|min:0|max:99999999.99',
            'monthly_discount' => 'nullable|decimal:0,2|min:0|max:100000',
            'preferred_price_type' => 'required|in:day,week,month',
            'limited_km' => 'boolean',
            'cancellation_available' => 'boolean',
            'price_per_km' => 'nullable|decimal:0,2|min:0|max:99999999.99',

            'registration_number' => 'required|string|max:50',
            'registration_country' => 'required|string|max:50',
            'registration_date' => 'required|date',
            'gross_vehicle_mass' => 'nullable|integer|min:0|max:20000',
            'vehicle_height' => 'nullable|decimal:0,2|min:0|max:5',
            'dealer_cost' => 'nullable|decimal:0,2|min:0|max:99999999.99',
            ...
            'limited_km_per_day_range' => 'nullable|decimal:0,2|min:0|max:99999999.99',
            'limited_km_per_week_range' => 'nullable|decimal:0,2|min:0|max:99999999.99',
            'limited_km_per_month_range' => 'nullable|decimal:0,2|min:0|max:99999999.99',
            ...
            'cancellation_fee_per_day' => 'nullable|numeric|min:0|max:99999999.99',
            'cancellation_available_per_week_date' => 'nullable|integer|min:0',
            'cancellation_available_per_month_date' => 'nullable|integer|min:0',
            'price_per_km_per_day' => 'nullable|decimal:0,2|min:0|max:99999999.99',
            'price_per_km_per_week' => 'nullable|decimal:0,2|min:0|max:99999999.99',
            'price_per_km_per_month' => 'nullable|decimal:0,2|min:0|max:99999999.99',
            'minimum_driver_age' => 'required|integer|min:18|max:99',
            ...
            'selected_plans.*.plan_value' => 'required|decimal:0,2|min:0|max:99999999.99',
            ...
            'custom_addons.*.price' => 'required|decimal:0,2|min:0|max:99999999.99',
            'custom_addons.*.quantity' => 'required|integer|min:1|max:999',
