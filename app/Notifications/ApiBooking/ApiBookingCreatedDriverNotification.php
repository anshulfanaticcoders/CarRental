...
class ApiBookingCreatedDriverNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return $mail
            ...
            ->line('**Pickup Date:** '.$this->booking->pickup_date->format('Y-m-d').' at '.$this->booking->pickup_time)
            ->line('**Return Date:** '.$this->booking->return_date->format('Y-m-d').' at '.$this->booking->return_time)
            ->line('**Dropoff Location:** '.($this->booking->return_location ?: $this->booking->pickup_location))
